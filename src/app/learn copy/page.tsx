...
const Practice = () => {
  ...
  const words = [
    ...
    },
    {
      ...
      definition:
        "Remarkable or exceptional, especially in an extraordinary way.",
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="title-text mb-6">Interactive Practice</h1>
            <p className="subtitle-text mb-10 max-w-2xl mx-auto">
              Perfect your English with our interactive pronunciation and
          ...
          <div className="text-center mt-16">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Complete practice exercises to unlock more advanced content and
                track your progress.
              </p>
              <a
                href="#"
                className="button-primary flex items-center gap-2 mx-auto w-fit"
              >
