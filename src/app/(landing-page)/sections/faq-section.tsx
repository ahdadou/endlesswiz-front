  ...
  const faqs = [
    {
      ...
      answer: "Currently, we support English. We plan to add more languages in the future.",
    },
    {
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">Find answers to common questions about our platform</p>
        </div>
