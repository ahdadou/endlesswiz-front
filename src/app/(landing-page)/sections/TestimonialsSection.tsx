            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-muted-foreground italic">
                  ...
                  pronunciation practice has given me more confidence in
              ...
              >
                ...
                <p className="text-muted-foreground italic">
                  "The vocabulary builder section has helped me expand my
                  English vocabulary significantly. The context-based approach
                  makes words easier to remember."
                </p>
              </motion.div>
            </div>
