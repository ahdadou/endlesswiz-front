...
const HangmanGame = ({ words=data }: { words: { word: string; meaning: string }[] }) => {
  const [selectedWord, setSelectedWord] = useState<{ word: string; meaning: string }>();
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 text-center">
      ...
      <motion.div className="text-3xl font-mono mb-6">
        {displayWord}
      </motion.div>
