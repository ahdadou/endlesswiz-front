  ...
  const videos = [
    {
      ...
      description:
        "Learn how to pronounce English vowel sounds with perfect clarity.",
    ...
    },
    {
      ...
      description:
        "Expand your professional vocabulary with these common business terms.",
      category: "vocabulary",
      duration: "12:45",
    },
    {
      ...
      description:
        "Learn how to maintain natural English conversations in informal settings.",
    ...
    },
    {
      ...
      description:
        "Practice pronouncing the most challenging English consonant sounds.",
      category: "pronunciation",
      duration: "14:35",
    },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="title-text mb-6">Learn with Video Lessons</h1>
            <p className="subtitle-text mb-10 max-w-2xl mx-auto">
              Watch expert-created videos to improve your pronunciation,
              vocabulary, and overall English fluency.
            </p>
