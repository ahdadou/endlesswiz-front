...
const VideoLibraryPage = () => {
  const { currentVideo, setVideos, videos, setCurrentVideo } = useZustandState();
  ...
  const fetchVideos = useCallback(async (pageNumber: number) => {
    ...
    try {
      ...
      var totalVideos = [...videos.videosDetailResponse, ...response.videosDetailResponse];
      setVideos({
        currentPage: response.currentPage,
        pageSize: totalVideos.length ?? 0,
        totalPages: response.totalPages,
        videosDetailResponse: pageNumber === 1 
    ...
    <div className="flex min-h-screen bg-background">
      <div className="flex-1 p-6 h-screen overflow-hidden">
        <div className="max-w-7xl mx-auto h-full flex flex-col">
          ...
          {/* Main Content */}
          <div className="flex gap-6 h-[100vh] overflow-hidden">
            ...
            <div 
              ref={listRef}
              className="w-[40%] flex flex-col gap-4 overflow-y-auto pr-4"
            >
