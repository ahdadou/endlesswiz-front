                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {userData.interests.map((interest, index) => (
                          <Badge
                            key={index}
                            variant="secondary"
                            className="text-forest bg-forest-100"
                          >
                            {interest}
                          </Badge>
                        ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <Card className="border-forest-100 shadow-sm">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Recent logins and activity on your account
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          <p className="font-medium">
                            Login from San Francisco, USA
                          </p>
                          <p className="text-xs text-muted-foreground">
                            Safari on macOS • IP: 192.168.1.2
                          </p>
                        </div>
                        <p className="text-xs text-muted-foreground">
                          Yesterday, 8:15 PM
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="rounded-md border p-4">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        ...
                        information, sets, and learning history.
                      </p>
                      <Button variant="outline" size="sm">
                        Export Data
                      </Button>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Use dark theme for studying at night
                        </p>
                      </div>
                      <Switch />
                    </div>
